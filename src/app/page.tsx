...
const TESTIMONIALS = [
  {
    quote:
      "I replaced my entire Linktree, website bio, and booking page with one Linkfolio link. My clients tell me it feels premium.",
    name: "Sarah K.",
  ...
  {
    quote:
      "Built my profile in 8 minutes. It went in my Twitter bio and drove 2,000 trial signups in the first month. No joke.",
    name: "Marcus T.",
  ...
  {
    quote:
      "My old link-in-bio looked like a grocery list. Linkfolio made it look like a gallery. Inquiries went up immediately.",
    name: "Yemi A.",
...
const STEPS = [
  {
    ...
    body: "linkfolio.app/yourname is yours in 60 seconds. No design skills. No credit card. Just your name.",
  },
  {
    n: "02",
    title: "Add your links",
    body: "Drop in your most important links — listings, bookings, portfolio, socials. Drag to reorder anytime.",
  },
  {
    n: "03",
    title: "Pick your look",
    body: "Choose an accent color that matches your brand. Watch the live preview update in real time on the right.",
  },
  {
    n: "04",
    title: "Drop it everywhere",
    body: "One link in your Instagram bio, email signature, and business card. Your whole world, one tap away.",
  },
];
    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(225,29,72,0.07) 0%, transparent 70%)",
          pointerEvents: "none",
          zIndex: 0,
      ...
      >
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(225,29,72,0.12) 0%, transparent 60%)",
            top: "-15%",
            right: "-10%",
            filter: "blur(80px)",
          }}
      ...
      >
        ...
        <div style={{ display: "flex", gap: 32, alignItems: "center" }}>
          ...
          <Link
            href={`/register?niche=${profile.niche}`}
            style={{
              fontSize: 12,
              padding: "9px 22px",
              borderRadius: 4,
      ...
      >
        ...
        <div style={{ animation: "fadeUp 0.7s ease both" }}>
          ...
          >
            ...
            >
              DRAG-AND-DROP REORDERING IS LIVE
            </span>
          </div>
          ...
          >
            ...
            <span
              style={{
                fontStyle: "italic",
                background:
                  "linear-gradient(135deg, #FF6B35 0%, #E11D48 50%, #FB7185 100%)",
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent",
              }}
            >
          ...
          >
            Real estate agents close more showings. SaaS founders drive more
            trials. Creators book more deals. One profile. Unlimited results.
          </p>
          ...
          >
            {[
              { n: "10,000+", l: "profiles live" },
              { n: "2.4M", l: "link clicks tracked" },
              { n: "< 60s", l: "to go live" },
            ].map(({ n, l }, i) => (
              <div
                key={l}
            ...
            {PROFILES.map((p, i) => (
              <button
                ...
                style={{
                  ...
                  boxShadow:
                    activeProfile === i ? `0 0 16px ${p.color}50` : "none",
                }}
              >
                {p.niche}
              </button>
          ...
          <div style={{ position: "relative" }}>
            ...
            >
              ...
              >
                ...
                >
                  linkfolio.app/
                  <span style={{ color: profile.color }}>{profile.handle}</span>
                </span>
              </div>
        ...
        >
          <div>
            ...
            >
              ...
              <br />
              <span
                style={{ fontStyle: "italic", color: "rgba(255,255,255,0.25)" }}
              >
                losing you money.
              </span>
            </h2>
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              {[
                {
                  pain: "Generic link trees look like everyone else's. You don't stand out.",
                },
                {
                  pain: "Visitors land, get confused by 12 equal-weight links, and leave.",
                },
                {
                  pain: "Your most important link — the one that makes you money — is buried.",
                },
                {
                  pain: "It screams 'side project', not 'serious professional'.",
                },
              ].map(({ pain }, i) => (
                <div
                  key={i}
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              {[
                {
                  fix: "Custom accent color and branded layout that's unmistakably yours.",
                },
                {
                  fix: "Drag your highest-converting link to the top. Watch clicks follow.",
                },
                {
                  fix: "Live split-screen editor — see exactly what your visitors see.",
                },
                {
                  fix: "Built for your niche. Looks expensive. Works even better.",
                },
              ].map(({ fix }, i) => (
                <div
                  key={i}
          ...
          {TESTIMONIALS.map((t, i) => (
            <button
              ...
              style={{
                ...
                borderRadius: 4,
                background:
                  i === activeTestimonial ? t.color : "rgba(255,255,255,0.15)",
                border: "none",
                cursor: "pointer",
                transition: "all 0.3s ease",
                boxShadow:
                  i === activeTestimonial ? `0 0 10px ${t.color}60` : "none",
              }}
            />
          ))}
        </div>
      ...
      >
        <div style={{ maxWidth: 900, margin: "0 auto", textAlign: "center" }}>
          ...
          >
            No hidden fees. No "feature locked" frustrations. Your full profile
            is free forever.
          </p>
          <div
            style={{
      ...
      >
        <div style={{ maxWidth: 640, margin: "0 auto" }}>
          ...
          >
            ...
            <span
              style={{
                fontStyle: "italic",
                background:
                  "linear-gradient(135deg, #FF6B35, #E11D48, #FB7185)",
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent",
              }}
            >
          ...
          >
            60 seconds. No card. No fluff.
            <br />
            Just a profile that finally matches your caliber.
          </p>
          <Link
            href="/register"
            style={{
              ...
              letterSpacing: "0.06em",
              boxShadow:
                "0 0 80px rgba(225,29,72,0.5), 0 8px 40px rgba(0,0,0,0.4)",
            }}
          >
      ...
      >
        ...
        >
          © 2025 Linkfolio · Built for professionals who are serious about their
          work.
        </div>
      </footer>
    </main>
